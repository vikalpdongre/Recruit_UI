...
def main_analyzer_app():
    ...
    resume_text_input = ""  
    resume_file = st.file_uploader("Choose a PDF or Word file for your Resume", type=["pdf", "docx"], key="resume_upload", accept_multiple_files=False)
    # Allow users to paste resume text as an alternative to file upload, hide and show text area check box
    if st.checkbox("You can also paste your resume text below if you prefer not to upload a file.", value=False, key="paste_resume_text_checkbox"):
